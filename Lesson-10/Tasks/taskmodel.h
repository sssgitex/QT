...
public:
    ...
    Q_INVOKABLE void addTask(QString name, QDate deadline, int progress);
    Q_INVOKABLE void addTaskFromString(QString string);
...
public:
    ...
    Q_INVOKABLE bool saveTasksToFile ();
...
private:
    ...
    const QString m_file = "tasks.txt";
